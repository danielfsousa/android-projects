...
import com.danisousa.beatbox.databinding.FragmentBeatBoxBinding;
import com.danisousa.beatbox.databinding.ListItemSoundBinding;
...
public class BeatBoxFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        binding.playbackSpeedTextview.setText(getString(R.string.playback_speed,
                mBeatBox.getPlayBackSpeedPercent()));
